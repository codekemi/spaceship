...
function Home() {
  return (
    <>
      ...
      <section className={styles["section__container"]}>
        <h2>🛸Amidst the Cosmos' Canvas, Infinite Adventures Beckon</h2>
        <p>
          Embark on an extraterrestrial escapade as you pilot your cosmic crew
          through the galaxy's tapestry. Glide between star-studded pit stops,
          hopping from one celestial hotspot to another. Unveil the cosmos'
          hidden treasures and turn distant orbs into your personal playgrounds.
          Your spacefaring saga awaits – adventure beyond the stars!
        </p>
      </section>
    </>
  );
